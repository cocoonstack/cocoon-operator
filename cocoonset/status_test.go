...
func TestBuildStatusReportsAgents(t *testing.T) {
	...
	main := readyPod(mustBuildAgentPod(t, cs, 0, "", "", testScheme(t)))
	sub1 := readyPod(mustBuildAgentPod(t, cs, 1, "vk-ns-demo-0-505043", "", testScheme(t)))
	classified := classifiedPods{
		main:      main,
	...
	if status.Agents[1].ForkedFrom != "vk-ns-demo-0-505043" {
...
func TestBuildStatusReportsDeadLetteredPods(t *testing.T) {
	...
	main := readyPod(mustBuildAgentPod(t, cs, 0, "", "", testScheme(t)))
	sub := readyPod(mustBuildAgentPod(t, cs, 1, "vk-ns-demo-0-505043", "", testScheme(t)))
...
func TestAgentStatusFromPod(t *testing.T) {
	...
	if st.VMName != "vk-ns-demo-0-505043" {
